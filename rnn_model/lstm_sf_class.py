...
########################################
    ...
    def plot(self, symbol_list):
        ...
        for ticker in symbol_list:
            ...
            self.train_and_plot(data_input, model_stateful, ticker)
...
###################################################
    ...
    def train_and_plot(self, data_input, model_stateful, ticker):
        expected_output = data_input.rolling(window=self.tsteps, center=False).mean()
        ...
        model_stateless = self.create_model(stateful=False)
        ...
        plt.plot((y_test - predicted_stateful).flatten()[self.tsteps - 1:])
